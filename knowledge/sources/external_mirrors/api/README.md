...
- `python3 knowledge/sources/external_mirrors/api/status.py --json`
- `python3 knowledge/sources/external_mirrors/api/search.py --query <query> --limit <n> --json`
- `python3 knowledge/sources/external_mirrors/api/lookup_external_symbol.py --symbol <name> --limit <n> --json`
