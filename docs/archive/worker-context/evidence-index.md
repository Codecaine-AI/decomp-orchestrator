...
Use this reference when you need concrete examples behind the Melee decomp worker context.
...
This worker context was distilled from the current repo-local `doldecomp/melee` past-PR
corpus. Refresh-window details live in
`decomp-orchestrator/knowledge/sources/past_prs/data/current/fetch_metadata.json`.

Local dump:

```text
decomp-orchestrator/knowledge/sources/past_prs/data/current
```
...
- `decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/human_pr_text.md`: human PR bodies, issue comments, and review bodies
- `decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/review_comments.md`: inline review comments with diff hunks
- `decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/text_corpus.jsonl`: structured PR/comment/review text records
- `decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/diff_lines.jsonl`: structured added/deleted diff lines
- `decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/changed_files.jsonl`: per-PR changed file records
- `decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/decomp_tips_library.md`: longer narrative summary that preceded this worker context
- `decomp-orchestrator/knowledge/sources/past_prs/data/prs/index.csv`: spreadsheet-friendly per-PR knowledge index
- `decomp-orchestrator/knowledge/sources/past_prs/data/prs/index.jsonl`: structured per-PR knowledge index for search/RAG ingestion
- `decomp-orchestrator/knowledge/sources/past_prs/data/prs/known_fixes.md`: compact human-readable rollup of recurring lessons
- `decomp-orchestrator/knowledge/sources/past_prs/data/prs/pr-*/postmortem.json`: structured per-PR postmortem records

Resource-guided lookup files:

- `decomp-orchestrator/knowledge/sources/resource_guides/data/index.md`: human-readable index for local decomp resources
- `decomp-orchestrator/knowledge/sources/resource_guides/data/manifests/resource_index.csv`: machine-readable resource manifest
- `decomp-orchestrator/knowledge/sources/resource_guides/data/manifests/acquisition_queue.csv`: pull status for mirrored and candidate external resources
- `decomp-orchestrator/knowledge/sources/ssbm_data_sheet/data/csv/sheet_index.csv`: generated workbook sheet index
- `decomp-orchestrator/knowledge/sources/ssbm_data_sheet/data/csv/cells.csv`: normalized searchable SSBM data sheet cell index
- `decomp-orchestrator/knowledge/sources/powerpc_docs/data/indexes/powerpc_pdf_pages.csv`: page-level ABI, compiler-guide, and ISA text index
- `decomp-orchestrator/knowledge/sources/external_mirrors/data/training_mode/indexes/gtme01_map_symbols.csv`: debugger MAP address/name hint index
- `decomp-orchestrator/knowledge/sources/external_mirrors/data/m_ex/indexes/header_symbols.csv`: m-ex header name hint index
- `decomp-orchestrator/knowledge/sources/powerpc_docs/data/pdfs/PPCEABI.pdf`, `decomp-orchestrator/knowledge/sources/powerpc_docs/data/pdfs/powerpc-cwg.pdf`, `decomp-orchestrator/knowledge/sources/powerpc_docs/data/pdfs/ppc_isa.pdf`: ABI, compiler-pattern, and instruction references
...
```bash
rg -n "M2C_FIELD|pointer math|GET_GROUND|union-field" decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/review_comments.md decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/human_pr_text.md decomp-orchestrator/knowledge/sources/past_prs/data/prs/known_fixes.md
rg -n "sdata2|literal|ordering|fakeFunc|symbols.txt" decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/review_comments.md decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/human_pr_text.md decomp-orchestrator/knowledge/sources/past_prs/data/prs/known_fixes.md
rg -n "PAD_STACK|inline|register|regalloc|FPR|local" decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/review_comments.md decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/human_pr_text.md decomp-orchestrator/knowledge/sources/past_prs/data/prs/known_fixes.md
rg -n "objdiff|checkdiff|require-protos|functionRelocDiffs" decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/human_pr_text.md decomp-orchestrator/knowledge/sources/past_prs/data/prs/index.jsonl
```

Use structured files when counts or PR grouping matter:

```bash
jq 'select(.pr == 2373)' decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/text_corpus.jsonl
jq 'select(.pr == 2373 and .change == "add")' decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/diff_lines.jsonl
```
