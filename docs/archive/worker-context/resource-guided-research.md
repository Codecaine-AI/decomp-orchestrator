...
jq 'select(.pr == 2510)' decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/diff_lines.jsonl
```
...
```bash
sed -n '1,180p' decomp-orchestrator/knowledge/sources/resource_guides/data/index.md
```
...
```bash
sed -n '1,80p' decomp-orchestrator/knowledge/sources/ssbm_data_sheet/data/csv/hitbox_offsets.csv
sed -n '1,80p' decomp-orchestrator/knowledge/sources/ssbm_data_sheet/data/csv/char_data_offsets.csv
```
...
pdftotext -layout decomp-orchestrator/knowledge/sources/powerpc_docs/data/pdfs/ppc_isa.pdf - | rg -n "mcrfs|rlwinm|Condition Register"
pdftotext -layout decomp-orchestrator/knowledge/sources/powerpc_docs/data/pdfs/PPCEABI.pdf - | rg -n "r3|stack frame|parameter"
pdftotext -layout decomp-orchestrator/knowledge/sources/powerpc_docs/data/pdfs/powerpc-cwg.pdf - | rg -n "compare|conversion|branch"
```
