...
- `decomp-orchestrator/knowledge/sources/past_prs/data/current/analysis/decomp_tips_library.md`: longer narrative summary that preceded this knowledge pack
